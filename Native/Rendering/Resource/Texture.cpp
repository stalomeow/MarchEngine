...
namespace dx12demo
{
    ...
    {
        // by ChatGPT
        static uint8_t ddsData[] =
        {
            // DDS 文件标识符 "DDS " (4 bytes)
            0x44, 0x44, 0x53, 0x20,
            ...
            // Reserved1 (11 * 4 bytes)
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,

            // Pixel Format size (4 bytes)
            0x20, 0x00, 0x00, 0x00,

            // Flags (4 bytes)
            0x41, 0x00, 0x00, 0x00,

            // FourCC (4 bytes) 0 for uncompressed, or DX10 for DXGI formats
            0x00, 0x00, 0x00, 0x00,
            ...
            // DXGI_FORMAT_R8G8B8A8_UNORM format (16 bytes)
